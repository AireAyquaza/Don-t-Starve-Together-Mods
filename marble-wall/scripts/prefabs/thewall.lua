...
function MakeTheWallType(data)
    ...
    local function ondeploywall(inst, pt, deployer)
        ...
        if thewall ~= nil then 
            ...
            thewall.Physics:Teleport(pt:Get())
...
local thewalldata =
{
	{name = "pomarble", tags={"stone", "pomarble"}, loot = "marble", maxloots = 2, maxhealth=TUNING.MOONROCKWALL_HEALTH, buildsound="dontstarve/common/place_structure_stone", destroysound="dontstarve/common/destroy_stone"},
}
